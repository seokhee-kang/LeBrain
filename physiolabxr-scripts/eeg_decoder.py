...
class eeg_decoder(RenaScript):
    def __init__(self, *args, **kwargs):
        ...
        self.model.load_weights("/Users/Aymeric/PycharmProjects/neureality/LeBrain/model/LR_weights.h5")

        #self.model = load_model('/Users/Aymeric/PycharmProjects/neureality/LeBrain/model/LR.h5')
        print('model loaded!')

        # TODO: will use that thing later
    ...
    def loop(self):
        ...
        data = self.model.predict(tf.convert_to_tensor(data),
                                  verbose=0)
